            ...
            List.of(
                    new ReferencesGroup(
                            ...
                            List.of(
                                    ...
                                    new Reference(
                                            "넓은 좌석 간격",
                                            List.of("앞,뒤,옆 간격이 넓어서 관람 시 편해요!")
                                    )
                            )
                    )
            ),
            ...
            List.of(
                    new ReferencesGroup(
                            ...
                            List.of(
                                    new Reference(
                                            "편리한 음식 섭취",
                                            List.of("테이블 석이라, 편리하게 음식을 먹을 수 있어요.")
                                    ),
                                    new Reference(
                                            "전용 게이트, 팔찌",
                                            List.of(
            ...
            List.of(
                    new ReferencesGroup(
                            ...
                            List.of(
                                    ...
                                    new Reference("가까운 게이트",
                                            List.of("중앙게이트 6~7 입구로 들어가면 가장 가까워요.")
                                    ),
                                    new Reference("엄청난 시야",
                                            List.of("수원KT위즈파크에서 손꼽힐 만큼 시야가 정말 좋아요.")
                                    )
                            )
                    )
            ),
