...
public enum UserErrorStatus implements BaseErrorCode {
    ...
    _EXPIRED_AUTH_CODE(HttpStatus.UNAUTHORIZED, "USER-003", "인증코드가 만료되었습니다. 인증코드를 재발급해주세요."),
    _MISS_MATCH_AUTH_CODE(HttpStatus.BAD_REQUEST, "USER-004", "인증코드가 일치하지 않습니다."),
    _EXISTING_USER_ACCOUNT_KAKAO(HttpStatus.FORBIDDEN, "USER-005", "이미 회원가입된 카카오 계정이 존재합니다."),
    _EXISTING_USER_ACCOUNT_GOOGLE(HttpStatus.FORBIDDEN, "USER-006", "이미 회원가입된 구글 계정이 존재합니다."),
    _EXISTING_USER_ACCOUNT_NAVER(HttpStatus.FORBIDDEN, "USER-007", "이미 회원가입된 네이버 계정이 존재합니다."),
