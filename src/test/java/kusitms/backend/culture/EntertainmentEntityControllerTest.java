...
public class EntertainmentEntityControllerTest extends ControllerTestConfig {

    @MockBean
    private StadiumApplicationService stadiumService;
    ...
    public void getSuitableEntertainments() throws Exception {
        ...
        Mockito.when(stadiumService.getSuitableEntertainments(anyString(), anyString())).thenReturn(getEntertainmentsResponseDto);
