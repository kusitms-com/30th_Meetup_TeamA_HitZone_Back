...
public class FoodEntityControllerTest extends ControllerTestConfig {
    ...
    public void getSuitableFoods() throws Exception {
        ...
        Mockito.when(stadiumService.getFoodsOnCondition(anyString(), anyString(), anyString())).thenReturn(getFoodsResponseDto);
